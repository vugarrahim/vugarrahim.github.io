...
(/** @lends <global> */function( $ ) {
	 ...
	 * useful and API, so we list, or at least document, all variables which are used
	 ...
	 * for the extensions to provide the same ability as DataTables useful to accept
	...
	DataTable.ext = _ext = {
		 ...
		 * order. It is _not_ used by DataTables useful.
		 *
		 *  @type object
		 *  @default {}
		 */
